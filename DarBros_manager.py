...
class action:
    def __init__(self):
        ...
        # 데이터베이스
        ## 각 데이터 리스트
        self.file_path_list = []        # 파일 경로 (Unique)
        self.file_PID_list = []         # Product ID
        self.file_CID_list = []         # Content ID
        self.file_suffix_list = []      # 접미사
        self.img_path_list = []         # 파일 이미지 경로
        self.file_actor_name_list = []
        ## 데이터 리스트 딕셔너리
